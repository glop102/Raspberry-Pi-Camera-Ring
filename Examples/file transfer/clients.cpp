...
int main(int argc, char *argv[])
{
    ...
    itoa(strlen(argv[2]+lastIndexOf(argv[2],'/')+1),filenameLengthA);
    printf("Filename        %s\nFileLength      %s\n", argv[2]+lastIndexOf(argv[2],'/')+1,filenameLengthA);

    //tell the name of the file
    write(socketFD,filenameLengthA,strlen(filenameLengthA));
    write(socketFD,&fieldSeperator,1);
    write(socketFD,argv[2]+lastIndexOf(argv[2],'/')+1,strlen(argv[2]+lastIndexOf(argv[2],'/')+1));
    write(socketFD,&fieldSeperator,1);
